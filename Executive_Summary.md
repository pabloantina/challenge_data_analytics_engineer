...
* Como asi también se podra visualizar el modelo estrella creado [modelo de datos en estrella](sql/modelo_estrella_estandarizado.sql), el cúal tiene como fin ser utilizado para consultas analíticas. A su vez, se podrá visualizar pequeños códigos creados para responder a ejercicios solicitados y consultas específicas.
